...
function(_pivot_apply_shm_bridge_overrides target_name)
    if(target_name STREQUAL "shm_bridge" AND EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/../cpp/shm_bridge.cpp")
        target_sources(${target_name} PRIVATE ${CMAKE_CURRENT_SOURCE_DIR}/../cpp/shm_bridge.cpp)
        if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/../cpp/shm_segment.cpp")
            target_sources(${target_name} PRIVATE ${CMAKE_CURRENT_SOURCE_DIR}/../cpp/shm_segment.cpp)
        endif()
        if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/../cpp/uid.cpp")
            target_sources(${target_name} PRIVATE ${CMAKE_CURRENT_SOURCE_DIR}/../cpp/uid.cpp)
        endif()
        target_include_directories(${target_name} PRIVATE ${CMAKE_CURRENT_SOURCE_DIR}/../cpp)
...
function(_pivot_apply_elbo_sdk_shm_manager_overrides target_name)
    # Keep shm_manager thin by moving name/size planning into C++.
    if(target_name STREQUAL "shm_manager")
        if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/../cpp/shm_manager_api.cpp")
            target_sources(${target_name} PRIVATE ${CMAKE_CURRENT_SOURCE_DIR}/../cpp/shm_manager_api.cpp)
        endif()
        if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/../cpp/uid.cpp")
            target_sources(${target_name} PRIVATE ${CMAKE_CURRENT_SOURCE_DIR}/../cpp/uid.cpp)
        endif()
...
macro(_pivot_add_cython_modules MODULE_SOURCES WHEEL_PKG_DIR WHEEL_OUTPUT_DIR)
    ...
    foreach(mod_src ${MODULE_SOURCES})
        ...
        if(EXISTS ${SRC})
            ...
            _pivot_apply_elbo_sdk_shm_manager_overrides(${mod})
